...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact — Nasken Health</title>
        <link rel="canonical" href="https://www.naskenhealth.com/contact" />
        <meta
          name="description"
          content="Connect with Nasken Health for clinical partnerships, academic collaborations, or general inquiries about AI-driven digital health solutions."
        />
      </Helmet>
