    ...
    <main className="bg-white">
      <section className="max-w-3xl mx-auto px-4 py-16">
        ...
        <p className="text-slate-700 mb-6">
          NASKEN INC. (“Nasken Health”), responsible for this website, informs all users
          of the terms and conditions applicable when accessing and using this website.
        </p>

        <p className="text-slate-700 mb-6">
          By accessing this website, you are considered a user and agree to comply with
          the terms outlined here as well as any applicable laws and regulations. Nasken
          Inc. reserves the right to modify any content or terms at any time without
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700 mb-6">
          <li>
            <strong>Domain name:</strong> https://www.naskenhealth.com
          </li>
          <li>
            <strong>Trade name:</strong> Nasken Health
          </li>
          <li>
            <strong>Corporate name:</strong> Nasken Inc.
          </li>
          <li>
            <strong>Company registration:</strong> Delaware C-Corp
          </li>
          <li>
            <strong>Registered office:</strong> 867 Boylston Street, 5th Floor, Boston,
            MA 02116, USA
          </li>
          <li>
            <strong>Email:</strong>{" "}
        ...
        <p className="text-slate-700 mb-6">
          The website and its contents, including text, graphics, trademarks, logos, and
          source code, are the property of Nasken Inc. or licensed third parties. They
        ...
        <p className="text-slate-700 mb-6">
          Nasken Inc. is not responsible for any improper or unlawful use of the website
          or its contents. The company assumes no responsibility for technical issues or
          service interruptions beyond its control, nor for damages that may arise from
          the use of external links or third-party sites.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-3">User Obligations</h2>
        <p className="text-slate-700 mb-6">
          Users agree to use this website lawfully, avoiding activities that may harm
          Nasken Inc., other users, or the website infrastructure. Uploading malicious
          code, spam, or false information is prohibited.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-3">Third-Party Links</h2>
        <p className="text-slate-700 mb-6">
          This website may contain links to external resources. Nasken Inc. is not
          responsible for the accuracy, availability, or content of third-party
          websites. Use of external links is at the user’s own risk.
        </p>
        ...
        <p className="text-slate-700 mb-6">
          ...
          damages arising from use or inability to use this website, even if advised of
          the possibility of such damages. Content is provided “as is” without warranty.
        </p>
        ...
        <p className="text-slate-700 mb-6">
          ...
          Commonwealth of Massachusetts, United States. Users agree that any disputes
