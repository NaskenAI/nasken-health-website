    ...
    <main className="bg-white">
      <section className="max-w-3xl mx-auto px-4 py-16">
        ...
        <p className="text-slate-700 mb-6">
          ...
          <strong>Nasken Inc. (d/b/a Nasken Health)</strong>, 867 Boylston Street, 5th
          Floor, Boston, MA 02116, USA (
          <a className="text-sky-700" href="mailto:contact@nasken.ai">
            contact@nasken.ai
          </a>
          ) collects, uses, and discloses information when you use our website (
          <span className="text-slate-900">https://www.naskenhealth.com</span>) (the
          “Service”). By accessing or using the Service, you consent to this Policy. If
          you do not agree, please do not use the Service.
        </p>

        <h2 className="text-2xl font-semibold mt-10 mb-3">Changes to this Policy</h2>
        <p className="text-slate-700 mb-6">
          We may update this Policy at any time. The “Last Updated” date above reflects
          the latest version. Continued use after an update means you accept the
          changes.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700 mb-6">
          <li>
            <strong>Contact data</strong> you submit (name, email, phone, organization,
            message).
          </li>
          <li>
            <strong>Usage data</strong> (pages viewed, device, browser) via cookies or
            similar tech.
          </li>
          <li>
            <strong>Communications</strong> and responses if you contact us.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700 mb-6">
          ...
          <li>
            With consent, send updates or research invitations. You can opt out anytime.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700 mb-6">
          <li>
            <strong>Service providers</strong> (e.g., hosting, analytics, form handling)
            bound by contract.
          </li>
          <li>
            Authorities or others when required by law or to protect rights and safety.
          </li>
        ...
        <p className="text-slate-700 mb-6">
          ...
          transit, access controls, logging). No method is 100% secure; transmission is
          at your own risk.
        </p>
        ...
        <p className="text-slate-700 mb-6">
          ...
          processed in the U.S. and other countries. Where required, we use appropriate
          safeguards.
        </p>
        ...
        <p className="text-slate-700 mb-6">
          ...
          governed by their own policies. Review those policies when visiting external
          sites.
        </p>
