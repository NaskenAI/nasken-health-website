    ...
    <section id="product-flow" className="py-20 bg-ink-950 text-white">
      <div className="section grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative order-2 lg:order-1">
          <img
            src={productFlow}
            alt="Nasken Health journaling to therapist summary to clinician dashboard flow"
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-white/80 mb-8">
            Nasken Health enables continuous care by linking patient journaling, AI-assisted summaries,
            and clinician dashboards into a single, privacy-preserving workflow.
          </p>
            ...
            {[
              {
                ...
                text: "Patients log daily reflections and wellness indicators in a secure, guided interface.",
              },
              {
                Icon: Brain,
                title: "Therapist Summary",
                text: "AI models analyze journaling data and generate concise summaries for therapists.",
              },
              {
                Icon: BarChart3,
                title: "Clinician Dashboard",
                text: "Clinicians view emotional trends, progress insights, and engagement metrics.",
              },
            ].map(({ Icon, title, text }) => (
