    ...
    <section className="min-h-screen bg-white px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-sm text-gray-600 mb-8 flex flex-wrap gap-4">
          <span>Date posted: <time dateTime="2025-10-01">October 1, 2025</time></span>
          <span>Contact: <a href="mailto:contact@nasken.ai" className="underline">contact@nasken.ai</a></span>
        </div>
        ...
        <div className="border border-yellow-300 bg-yellow-50 text-yellow-900 p-4 rounded-md mb-10">
        ...
        <div className="flex gap-4">
          ...
          <a
            ...
            className="underline text-healthcare-teal self-center"
          >
